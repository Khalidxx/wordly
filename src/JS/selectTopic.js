                ...
                <div className="container-2">
                    ...
                    <div className="content">
                        <div className="dropdown">
                            <button onClick={this.myFunction} className="dropbtn">Select a topic
                        <div className="arrow old" ></div></button>

                            <div id="myDropdown" className="dropdown-content">
                                <Link to="/Puzzle">Weird words</Link>
                                <Link to="/Puzzle">Game of Thrones</Link>
                                <Link to="/Puzzle">Cities of the world</Link>
                            </div>
                        </div>
                    </div>
