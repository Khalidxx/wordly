                ...
                <div className="container-2">
                    ...
                    <div className="content">
                        <div className="dropdown">
                            <button onClick={this.myFunction} className="dropbtn">Select a mode<div className="arrow old" /></button>

                            <div id="myDropdown" className="dropdown-content">
                                <Link to={"/SelectDifficulty"}>Single player</Link>
                                <Link to={"/SelectDifficulty"}>Multiplayer</Link>
                            </div>
                        </div>
                    </div>
